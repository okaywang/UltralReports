...
namespace Website.Controllers
{
    public class HomeController : Controller
    {
        ...
        public PartialViewResult Table1()
        {
            ...
            model.B1 = instance.GetValue("FyFysis.CALC.A1003");
            ...
            model.G1 = instance.GetValue("Fysis.TLOPCRTS.MCS02B:HBZS.RO01");
            ...
            model.G2 = instance.GetValue("Fysis.TLOPCRTS.MCS04B:HBZS.RO01");
